...
The implementation of the language is available at \url{https://github.com/JonathanBrouwer/master-thesis/}. The \verb|final-simple| branch contains the implementation that is relevant for this paper. 
...
\begin{enumerate}
	...
	\item $s1 \vdash e1 \underset{\beta h}{\Rightarrow} e2$ is the same as \verb|betaReduce((s1, e1)) == e2|
