...
\begin{figure}[h]
	\figuresection{Type checking let}
	\begin{mathpar}
	\mprset{vskip=0.3ex}
		\inferrule{
			\inferrule{
			...
			\toe{s_0}{\co{Let}("T", \co{Type}(), b)}{\co{Type}()}
		}
	\mprset{vskip=0ex}
	\end{mathpar}

	\figuresection{Type checking let body}
	\begin{mathpar}
		\mprset{vskip=0.7ex}
		\inferrule{
			...
			\toe{s_1}{\co{FnDestruct}(\co{FnConstruct}("v", \co{Type}(), \co{Var}("v")), \co{Var}("T")))}{\co{Type}()}
		}
		\mprset{vskip=0ex}
	\end{mathpar}
