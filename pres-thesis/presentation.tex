...
\begin{frame}[fragile]{Background: What is Spoofax?}
SDF3, Statix and Stratego (and more)
	
\begin{figure}
	\includegraphics[width=0.32\linewidth]{img/semantics}
	\includegraphics[width=0.32\linewidth]{img/syntax}
	\includegraphics[width=0.32\linewidth]{img/transformation}
\end{figure}
\end{frame}
